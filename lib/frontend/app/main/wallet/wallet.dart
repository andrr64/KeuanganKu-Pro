...
class WalletPage extends HookConsumerWidget {
  ...
  void callbackWhenDataSaved(WidgetRef ref, DBModelExpenseLimiter newExpenseLimiter){
    ref.read(globalExpenseLimiterNotifierProvider.notifier).add(newExpenseLimiter);
  }
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final expenseLimiterProvider = ref.watch(globalExpenseLimiterNotifierProvider);
    ...
    return SingleChildScrollView(
      child: PagePadding(
        ...
        child: Column(
          ...
          children: [
            const BalanceCard( without_title: true, without_name: true,),
            dummyHeight(10),
            ExpenseLimiterCard(
